...
mysqldump --defaults-extra-file=${mySuperCredFile} --hex-blob ${sampleDb} --routines --no-create-db > ${websitesContentFolder}/documentation/schema/cyclestreetsSample.sql
