...
$packageInstall update-manager-core language-pack-en-base wget dnsutils man-db git nano bzip2 screen dos2unix rsync locate ncdu
updatedb
...
# Node.js; see: https://github.com/nodesource/distributions#installation-instructions
apt-get update
apt-get install -y ca-certificates curl gnupg
mkdir -p /etc/apt/keyrings
rm -f /etc/apt/keyrings/nodesource.gpg		# In case already exists
